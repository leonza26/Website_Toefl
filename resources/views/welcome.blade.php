...
<head>
    ...
    <title>Pusat Tes TOEFL - UIN SMDD Bukittinggi</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        <div class="container">
            <img src="{{ asset('img/logo_kampus.png') }}" style="width: 4rem;" alt="logo">
            <a class="navbar-brand fw-bold" href="#">UIN SMDD Bukittinggi</a>
                    ...
                    <div class="d-flex">
                        @auth
                            @if ($isAdmin)
                                ...
                                <a href="{{ url('/participant/dashboard') }}" class="btn btn-primary">
                                    Dashboard
                                </a>
                            @else
                                {{-- Jika pengguna sudah login, tampilkan tombol Dashboard --}}
            ...
            <div class="container">
                ...
                <div class="row text-center g-4">
                    <div class="col-md-4 fade-in">
                        ...
                        <p>Soal dan penilaian mengacu pada standar ETS untuk hasil yang akurat dan dapat
                    ...
                    <div class="col-md-4 fade-in">
                        ...
                        <p>Hasil tes dapat langsung dilihat dan diunduh sebagai dokumen resmi untuk keperluan akademik
                            Anda.</p>
                    </div>
                    <div class="col-md-4 fade-in">
                        <div class="feature-icon mb-3">
                        ...
                        <p>Gunakan sertifikat dari tes ini sebagai salah satu syarat wajib untuk sidang skripsi dan
                            yudisium.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4">
                    <div class="col-md-6 col-lg-4 fade-in">
                        <div class="card testimonial-card">
                            <div class="card-body">
                                <p class="card-text fst-italic">"Skor dari sini saya lampirkan untuk mendaftar program
                                    pertukaran pelajar ke Korea Selatan. Prosesnya jadi lebih mudah karena sertifikatnya
                                    diakui oleh pihak kampus."</p>
                    ...
                    <div class="col-md-6 col-lg-4 fade-in">
                        <div class="card testimonial-card">
                            <div class="card-body">
                                <p class="card-text fst-italic">"Sebagai syarat yudisium, tes di platform ini sangat
                                    efisien. Tidak perlu keluar kampus, hasilnya cepat, dan bisa langsung saya serahkan
                                    ke bagian akademik. Sangat membantu!"</p>
                                <div class="d-flex align-items-center mt-3">
                    ...
                    <div class="col-md-6 col-lg-4 fade-in">
                        <div class="card testimonial-card">
                            <div class="card-body">
                                <p class="card-text fst-italic">"Saya menggunakan hasil tes ini untuk melamar beasiswa
                                    internal kampus. Laporan skornya yang detail juga membantu saya fokus memperbaiki
                                    bagian Reading."</p>
                                <div class="d-flex align-items-center mt-3">
    ...
    <footer class="py-4 bg-dark text-white text-center">
        <div class="container">
            <p class="mb-0">© 2025 Pusat Bahasa UIN SMDD Bukittinggi. All Rights Reserved.</p>
        </div>
    </footer>
