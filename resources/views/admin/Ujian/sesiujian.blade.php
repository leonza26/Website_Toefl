...
<div class="row">
    <div class="col-12 col-lg-8">
        <div class="card shadow-sm border-0">
            ...
            <form action="{{-- route('admin.sesi_ujian.store') --}}" method="POST">
                @csrf
                <div class="card-body">
                    {{-- Judul Ujian --}}
                    <div class="mb-3">
                        <label for="judul_ujian" class="form-label fw-semibold">Judul Ujian</label>
                        <input type="text" class="form-control" id="judul_ujian" name="judul_ujian" placeholder="Contoh: Tes Penempatan TOEFL September 2025" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="bank_soal_id" name="bank_soal_id" required>
                            ...
                            {{-- NOTE: Loop data bank soal dari controller di sini --}}
                            <option value="1">Listening Part A: Short Conversations</option>
                            <option value="2">Structure: Incomplete Sentences</option>
                            <option value="3">Reading: Vocabulary and Reference</option>
                        </select>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" id="waktu_ujian" name="waktu_ujian" placeholder="Contoh: 120" required>
